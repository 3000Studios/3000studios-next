    ...
    <main className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="mb-12 text-center">
            ...
            <p className="font-mono text-xs text-red-500/70 tracking-[0.3em]">RESTRICTED ACCESS</p>
        </div>
        ...
        {error && (
            <div className="mt-8 p-4 border border-red-500/20 bg-red-900/10 text-center">
                <p className="font-mono text-xs text-red-500 tracking-widest animate-pulse">{error}</p>
            </div>
        )}
      </div>
    </main>
