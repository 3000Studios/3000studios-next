    ...
    <section className="p-10 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="card-premium hover-lift border-yellow-500">
          <div className="bg-yellow-500 text-black text-xs font-bold px-3 py-1 rounded-full mb-4 inline-block">
            POPULAR
          </div>
          <h3 className="text-2xl font-bold mb-2">Yearly</h3>
          <p className="text-4xl font-bold text-yellow-400 mb-4">
            $299<span className="text-lg">/yr</span>
          </p>
          <ul className="space-y-2 text-gray-400 mb-6">
            <li>✓ All features</li>
            <li>✓ Priority support</li>
          ...
          <button className="w-full bg-linear-to-r from-yellow-600 to-yellow-400 text-black px-6 py-3 rounded-lg font-bold hover:scale-105 transition-transform">
            Subscribe Yearly
          </button>
        </div>
        ...
        <div className="card-premium hover-lift">
          ...
          <p className="text-4xl font-bold text-yellow-400 mb-4">
            $999<span className="text-lg"></span>
          </p>
          <ul className="space-y-2 text-gray-400 mb-6">
            <li>✓ All features</li>
            <li>✓ Priority support</li>
