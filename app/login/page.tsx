    ...
    return (
        <div className='min-h-screen bg-black text-white flex flex-col items-center justify-center'>
            ...
            <form onSubmit={handleLogin} className='w-96 bg-gray-900 p-8 rounded'>
                <input name='email' placeholder='Email' className='w-full p-3 mb-4 rounded bg-gray-800'/>
                <input name='password' type='password' placeholder='Password' className='w-full p-3 mb-4 rounded bg-gray-800'/>
