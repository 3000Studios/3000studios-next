    ...
    <main className="relative min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-32 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-100 w-full overflow-hidden rounded-sm border border-white/10 group">
            <div className="absolute inset-0 bg-linear-to-br from-hologram/20 to-void z-10"></div>
            <video
              autoPlay
              muted
              loop
