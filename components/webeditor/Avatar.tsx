      ...
      <div className="w-full h-full relative z-10 flex flex-col items-center justify-center">
        ...
        <div className="w-32 h-40 bg-gradient-to-b from-purple-200 to-purple-400 rounded-[50px] shadow-[0_0_20px_rgba(255,255,255,0.4)] relative overflow-hidden border border-white/30">
            ...
            <div className="absolute top-14 w-full flex justify-center gap-4 px-4">
                <div className={`h-3 w-8 bg-black rounded-full transition-all duration-200 ${mood === 'sarcastic' ? 'rotate-12' : ''} overflow-hidden`}>
            ...
            <div className={`absolute bottom-8 left-1/2 -translate-x-1/2 bg-red-900/80 rounded-full transition-all duration-100 ${
                mood === 'talking' ? 'animate-pulse-fast w-10 h-6 border-2 border-red-400' : 
                mood === 'sarcastic' ? 'w-10 h-1 border-b-2 border-black rotate-6' : 'w-8 h-2'
            }`}></div>
