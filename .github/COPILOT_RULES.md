# COPILOT AUTONOMOUS CTO DIRECTIVE
...
- Remove dead code, unused files, obsolete scripts
- Optimize SEO, metadata, performance, accessibility
- Preserve ALL revenue systems (AdSense, Stripe, affiliates)
