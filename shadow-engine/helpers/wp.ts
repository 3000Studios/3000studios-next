...
const WP_BASE_URL = process.env.WORDPRESS_API_URL || "https://3000studios.com/wp-json/wp/v2";
...
export async function createWordPressPost(title: string, content: string): Promise<any> {
