...
export const metadata: Metadata = {
  title: "Best Passive Income Tools Online | 3000 Studios",
  description: "Generate revenue while you sleep with these proven digital tools. A comprehensive guide to automated income streams.",
...
<<<<<<< HEAD
            Generate revenue while you sleep with these proven digital tools. A
            comprehensive guide to automated income streams.
=======
            Generate revenue while you sleep with these proven digital tools. A comprehensive guide to automated income streams.
>>>>>>> origin/pr/50
          </p>
...
<<<<<<< HEAD
            Building wealth requires smart tools. We explore the top platforms
            for affiliate marketing, digital products, and automated
            dropshipping that generate real passive income.
          </p>
