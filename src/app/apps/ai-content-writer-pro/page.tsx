    ...
    >
      <div className="p-6 rounded-2xl border border-amber-300/30 bg-white/5 backdrop-blur-xl shadow-2xl">
        ...
        <div className="grid md:grid-cols-3 gap-3 text-sm text-gray-100/90">
          <div className="p-4 rounded-xl bg-black/40 border border-amber-200/20">Blog outlines → drafts → meta → schema</div>
          <div className="p-4 rounded-xl bg-black/40 border border-amber-200/20">Social packs per platform + hooks</div>
          <div className="p-4 rounded-xl bg-black/40 border border-amber-200/20">Email sequences for launches and onboarding</div>
          <div className="p-4 rounded-xl bg-black/40 border border-amber-200/20">CTA and headline multivariate options</div>
          <div className="p-4 rounded-xl bg-black/40 border border-amber-200/20">Brand voice snapshots for teams</div>
          <div className="p-4 rounded-xl bg-black/40 border border-amber-200/20">Calendar exports to CMS</div>
        </div>
      </div>
    </AppLanding>
  );
