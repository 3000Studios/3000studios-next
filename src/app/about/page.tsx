          ...
          <section className="max-w-4xl mx-auto py-8">
            <div className="bg-gradient-to-br from-gray-900/50 to-black/50 p-12 rounded-lg border-2 border-[#D4AF37] glossy-overlay mb-12">
              ...
              <p className="text-lg text-gray-300 mb-4 leading-relaxed">
                3000 Studios is a creative powerhouse dedicated to pushing the
                boundaries of digital art, development, and design. We
                specialize in creating stunning visual experiences, innovative
                code solutions, and premium digital products.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                Our team combines technical expertise with artistic vision to
                deliver exceptional results that inspire and engage. From live
                wallpapers to custom code snippets, every project is crafted
