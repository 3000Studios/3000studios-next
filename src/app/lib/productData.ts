...
const AMAZON_AFFILIATE_TAG =
  process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG || "3000studios-20";
const CLICKBANK_AFFILIATE_URL =
  process.env.NEXT_PUBLIC_CLICKBANK_AFFILIATE_URL ||
  "https://3000studios.pay.clickbank.net";
const JVZOO_AFFILIATE_URL =
  process.env.NEXT_PUBLIC_JVZOO_AFFILIATE_URL ||
  "https://www.jvzoo.com/3000studios";
...
export const productCatalog: Product[] = [
  ...
  // =====
  {
    ...
    description:
      "High-quality 4K webcam perfect for content creators, streamers, and professionals. Features autofocus, HDR, and stereo microphones. Ideal for YouTube, Twitch, and business meetings.",
    price: 129.99,
    category: "Hardware",
    rating: 4.7,
    reviewCount: 8453,
  ...
  },
  {
    ...
    description:
      "Premium mechanical keyboard with customizable RGB lighting, programmable keys, and tactile switches. Perfect for developers, gamers, and power users.",
    price: 89.99,
    category: "Hardware",
    rating: 4.6,
    reviewCount: 12789,
  ...
  },
  {
    ...
    description:
      "Professional condenser microphone for podcasting, streaming, voiceovers, and music recording. Plug-and-play USB connection with zero latency monitoring.",
    price: 149.99,
    category: "Hardware",
    rating: 4.8,
    reviewCount: 15234,
  ...
  },
  {
    ...
    description:
      "Lightning-fast portable SSD with USB-C 3.2 Gen 2 for blazing transfer speeds up to 1050MB/s. Perfect for video editors, photographers, and content creators.",
    price: 179.99,
    category: "Hardware",
    rating: 4.9,
    reviewCount: 9876,
  ...
  },
  {
    ...
    description:
      "High-back mesh office chair with lumbar support, adjustable armrests, and headrest. Designed for all-day comfort during long coding or design sessions.",
    price: 299.99,
    category: "Office",
    rating: 4.5,
    reviewCount: 6543,
  ...
  },
  {
    ...
    description:
      "Professional pen display tablet with 8192 pressure levels, battery-free stylus, and full lamination. Perfect for digital artists, illustrators, and designers.",
    price: 449.99,
    category: "Hardware",
    rating: 4.7,
    reviewCount: 4321,
  ...
  // =====
  {
    ...
    description:
      "Master full-stack web development from zero to hero. Includes HTML, CSS, JavaScript, React, Node.js, MongoDB, and deployment. 300+ hours of content with projects.",
    price: 199.99,
    category: "Education",
    rating: 4.9,
    reviewCount: 45678,
  ...
  },
  {
    ...
    description:
      "Learn artificial intelligence and machine learning from industry experts. Covers Python, TensorFlow, PyTorch, neural networks, and real-world AI applications.",
    price: 249.99,
    category: "Education",
    rating: 4.8,
    reviewCount: 23456,
  ...
  },
  {
    ...
    description:
      "Complete guide to social media marketing across all major platforms. Learn content strategy, paid advertising, influencer marketing, and analytics.",
    price: 149.99,
    category: "Marketing",
    rating: 4.7,
    reviewCount: 18901,
  ...
  },
  {
    ...
    description:
      "Learn how to create and sell digital products for passive income. Covers product creation, marketing, automation, and scaling your online business.",
    price: 179.99,
    category: "Business",
    rating: 4.6,
    reviewCount: 12345,
  ...
  },
  {
    ...
    description:
      "Complete graphic design training covering Photoshop, Illustrator, InDesign, and Figma. From basics to advanced techniques with 50+ real projects.",
    price: 189.99,
    category: "Design",
    rating: 4.8,
    reviewCount: 19234,
  ...
  },
  {
    ...
    description:
      "Proven strategies to grow your YouTube channel from 0 to 100K+ subscribers. Covers content creation, SEO, thumbnails, monetization, and sponsorships.",
    price: 159.99,
    category: "Marketing",
    rating: 4.7,
    reviewCount: 16789,
  ...
  },
  {
    ...
    description:
      "Advanced SEO training to dominate search rankings. Learn keyword research, on-page optimization, link building, technical SEO, and content strategy.",
    price: 169.99,
    category: "Marketing",
    rating: 4.8,
    reviewCount: 14567,
  ...
  // =====
  {
    ...
    description:
      "Professional video editing software with 4K support, motion graphics, color grading, and audio editing. One-time payment, lifetime updates included.",
    price: 299.99,
    category: "Software",
    rating: 4.6,
    reviewCount: 8765,
  ...
  },
  {
    ...
    description:
      "Build stunning websites without coding. Includes 500+ templates, e-commerce, SEO tools, and hosting. Perfect for businesses and freelancers.",
    price: 29.99,
    category: "Software",
    rating: 4.5,
    reviewCount: 11234,
  ...
  },
  {
    ...
    description:
      "Complete email marketing platform with automation workflows, A/B testing, segmentation, and detailed analytics. Grow your list and boost conversions.",
    price: 49.99,
    category: "Software",
    rating: 4.7,
    reviewCount: 9876,
