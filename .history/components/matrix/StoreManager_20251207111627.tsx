...
}  );    </div>      </div>        <p className="text-sm text-gray-400">Revenue Today: $0</p>        <p className="text-sm text-gray-400">Total Products: 0</p>      <div className="p-4 mt-4 border border-gray-700 rounded-lg bg-black/50">