...
}  );    </div>      </div>        <p className="text-sm text-gray-400">Revenue Today: $0</p>        <p className="text-sm text-gray-400">Total Products: 0</p>      <div className="mt-4 p-4 bg-black/50 rounded-lg border border-gray-700">