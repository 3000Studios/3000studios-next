...
export default function StoreManager() {
  ...
  return (
    <div className="bg-black/60 backdrop-blur-xl border border-yellow-500/30 p-6 rounded-xl shadow-2xl">
      ...
      </div>        <p className="text-sm text-gray-400">Revenue Today: $0</p>        <p className="text-sm text-gray-400">Total Products: 0</p>      <div className="mt-4 p-4 bg-black/50 rounded-lg border border-gray-700">